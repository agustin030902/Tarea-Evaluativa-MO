...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{../figures/convergence_analysis_20251223-162610.png}
    \caption{Mapa de regiones de convergencia para los distintos algoritmos de optimización.}
    \label{fig:heatmap}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{../figures/tiempo_vs_iteraciones_real_20251223-162941.png}
    \caption{Evolución de la función objetivo, norma del gradiente y distancia al óptimo.}
...
en los experimentos exitosos, medida mediante $-\log_{10}(f(x,y))$.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{../figures/histograma_precision_real_20251223-163037.png}
    \caption{Distribución de la precisión final lograda por los algoritmos en los experimentos.}
    \label{fig:precision}
\end{figure}

Los métodos de segundo orden alcanzan niveles de precisión superiores, aunque con una
